                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('register.guest') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="contact_no" placeholder="{{ __('Contact Number') }}" value="{{ old('last_name') }}" required>
                                    </div>
